...
import LabRequestModal from '../../components/lab/LabRequestModal.jsx';
  ...
  return (
    <main style={{ fontFamily: FONT, background: '#F8FAFB', minHeight: '70vh', paddingBottom: 96 }}>
        ...
        <div className="td-cta">
          ...
          {isLabResultCheckTest ? (
            <div className="td-cta-btn-group">
              ...
              >
                {t('testDetail.requestTestCta')}
              </button>
              <button
                type="button"
                onClick={() => navigate('/e-netice')}
                className="td-cta-btn td-cta-btn-secondary"
              >
                {t('testDetail.checkResultCta')}
              </button>
            </div>
      ...
      <style>{`
        ...
        .td-cta-btn-secondary:hover { background: rgba(0,132,142,0.08); }
        ...
        @media (max-width: 768px) {
          ...
          .td-cta-btn-group { order: 4; width: 100%; flex-direction: column; }
          .td-cta-btn-group .td-cta-btn { width: 100%; }
