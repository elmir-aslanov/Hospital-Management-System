...
router.get('/patient/:patientId/latest', authorize('ADMIN', 'DOCTOR', 'NURSE', 'PATIENT'), vitalsController.getLatestVitals);
router.get('/patient/:patientId/trend',  authorize('ADMIN', 'DOCTOR', 'NURSE', 'PATIENT'), vitalsController.getVitalsTrend);
